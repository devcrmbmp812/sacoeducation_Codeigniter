...
class VideoModel extends CI_Model
{
    ...
    public function getVideoPlaylist($data, $episode = FALSE)
    {
        if ($episode === FALSE) {
            ...
            $videoPlaylist['description'][] = mb_strimwidth(strip_tags($data['description']), 0, 60, '...');
        ...
        foreach ($query->result() as $row) {
            ...
            $videoPlaylist['description'][] = mb_strimwidth(strip_tags($row->description), 0, 60, '...');

                ...
                <div class="navbar navbar-default navbar-hide bg-transparent" role="navigation">
                    <div class="landing-container">
                        ...
                        <div class="topbar-left p-0">
                            <a href="<?php echo site_url('login/');?>" class="logo"><?php if (NULL !==$this->config->item('logo')) echo $this->config->item('logo'); ?></a>
                        </div>
                ...
                <div class="row">
                    <div class="container">
                        <div class="col-sm-12 header-title-box-landing">
                            ...
                            <button class="btn btn-custom btn-large btn-lg btn-green pull-right">JOIN FREE FOR A MONTH</button>
                        </div>
                    </div>
                </div>
                <div class="row">

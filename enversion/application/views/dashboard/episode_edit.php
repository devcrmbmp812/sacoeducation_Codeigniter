			...
			<div class="row">
							...
							<div class="col-sm-12">
								<div class="form-group m-b-20">
									...
									<select class="form-control selectpicker show-tick" data-style="btn-white" name="type">
										<option value="0" <?php if(isset($type) && $type === '0') echo 'selected'; ?>><?php echo $this->lang->line('Embedded Video'); ?></option>
										<option value="1" <?php if(isset($type) && $type === '1') echo 'selected'; ?>><?php echo $this->lang->line('Hosted Video'); ?></option>
										<option value="2" <?php if(isset($type) && $type === '2') echo 'selected'; ?>><?php echo $this->lang->line('YouTube Video'); ?></option>
										<option value="3" <?php if(isset($type) && $type === '3') echo 'selected'; ?>><?php echo $this->lang->line('Vimeo Video'); ?></option>
									</select>
								</div>
							</div>
							<div class="col-sm-12">
								<div id="embed" class="form-group m-b-20" <?php if(isset($type) && $type == 1) echo 'style="display:none;' ?>>
				...
				<?php if($this->uri->segment(3, 0) === 'editepisode') { ?>
    				<div class="<?php echo ($this->uri->segment(3, 0) === 'add') ? 'col-sm-12' : 'col-sm-3'; ?>">
    					...
    					<form class="userFile" method="post" action="<?php echo current_url().'/'; ?>" role="form" enctype="multipart/form-data" accept-charset="utf-8" <?php if($type != 1) echo 'style="display:none;"'; ?>>
